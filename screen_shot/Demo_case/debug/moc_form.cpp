...
QT_MOC_LITERAL(1, 5, 18), // "sigEndScreenShared"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Form\0sigEndScreenShared\0"
};
...
void Form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigEndScreenShared(); break;
        default: ;
        }
        ...
        {
            using _t = void (Form::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Form::sigEndScreenShared)) {
                *result = 0;
                return;
            }
        }
